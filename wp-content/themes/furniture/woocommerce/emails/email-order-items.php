...
foreach ( $items as $item ) :
	...
	<tr>
		...
		?></td>
		<td style="text-align:left; vertical-align:middle; border: 1px solid #eee;"><?php echo balanceTags($item['qty']) ;?></td>
		<td style="text-align:left; vertical-align:middle; border: 1px solid #eee;"><?php echo balanceTags($order->get_formatted_line_subtotal( $item )); ?></td>
	</tr>
