		...
		<?php else : ?>
			...
			<?php if ( is_cart() ) : ?>
				...
				<?php echo apply_filters( 'woocommerce_cart_no_shipping_available_html',
					...
					'<div class="woocommerce-info"><p>' . esc_html__( 'There doesn&lsquo;t seem to be any available shipping methods. Please double check your address, or contact us if you need any help.', 'woocommerce' ) . '</p></div>'
			...
			<?php else : ?>
				...
				<?php echo apply_filters( 'woocommerce_no_shipping_available_html',
					...
					'<p>' . esc_html__( 'There doesn&lsquo;t seem to be any available shipping methods. Please double check your address, or contact us if you need any help.', 'woocommerce' ) . '</p>'
