	...
	<div class="item">
		...
		<?php   $thumbnail_id = get_woocommerce_term_meta( $term->term_id, 'thumbnail_id', true ); ?>
			...
			<div class="row m0 hovArea">
				<i class="fa fa-heart-o"></i><br><h4><?php echo sprintf( _n( '1 item', '%s items', $term->count, SH_NAME), $term->count );?></h4><a href="<?php echo esc_url(get_term_link($term));  ?>"><?php esc_html_e('SHOP NOW', SH_NAME);?></a>
			</div>
			<?php endif; ?>
		</div>
