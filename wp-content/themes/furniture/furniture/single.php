	...
	<div class="row">
		...
		<div class="<?php echo esc_attr($classes);?>">                    
			...
			<div class="blog row m0 single_post">
				...
				<div class="row m0 titleRow">
					...
					<div class="fleft titlePart">
						...
						<p class="m0"><?php esc_html_e('By ', SH_NAME);?><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php the_author();?></a><span>|</span><a href="<?php the_permalink();?>#comments"><?php comments_number();?></a></p>
					</div>
				</div>
			...
			<div class="shareRow row m0">
				<h4 class="heading fleft"><?php esc_html_e('Share this post', SH_NAME);?></h4>
			...
			<div class="media authorBox">
				...
				<div class="media-body">
					<h5 class="heading"><?php esc_html_e('About ', SH_NAME);?><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' )); ?>">Dwayne Johnson</a></h5>
					<p><?php the_author_meta( 'description', get_the_author_meta('ID') ); ?></p>
				</div>
				<div class="row m0">
					<ul class="list-inline">
						<?php if($facebook_url = get_the_author_meta('facebook')):?>
							<li><a href="<?php echo esc_url($facebook_url); ?>"><i class="fa fa-facebook"></i><?php esc_html_e(' Facebook', SH_NAME);?></a></li>
						<?php endif;?>
						<?php if($twitter_url = get_the_author_meta('twitter')):?>
							<li><a href="<?php echo esc_url($twitter_url);?>"><i class="fa fa-twitter"></i><?php esc_html_e(' twitter', SH_NAME);?></a></li>
						<?php endif;?>
						<?php if($google_plus_url = get_the_author_meta('google-plus')):?>
							<li><a href="<?php echo esc_url($google_plus_url);?>"><i class="fa fa-google-plus"></i><?php esc_html_e(' google+', SH_NAME);?></a></li>
						<?php endif;?>
						<?php if($email_url = get_the_author_meta('user_email')):?>
							<li><a href="mailto:<?php echo esc_attr($email_url); ?>"><i class="fa fa-envelope"></i><?php esc_html_e(' Email', SH_NAME);?></a></li>
						<?php endif;?>
					</ul>
				</div>
