	 ...
	 <div class="col-sm-5">
		...
		<div class="row m0">
			...
			<div class="row m0 colorSelect">
				<h5 class="heading proAttr"><?php esc_html_e('Color :', SH_NAME);?></h5>
			...
			<div class="row m0">
				<ul class="list-inline wce">
					<li><a href="javascript:void(0);" class="add_to_wishlist" data-id="<?php the_ID(); ?>"><img src="<?php echo get_template_directory_uri();?>/images/icons/heart.png" alt=""><?php esc_html_e('Add to Wishlist', SH_NAME);?></a></li>
					<li><a href="javascript:void(0);" class="add_to_compare" data-id="<?php the_ID(); ?>"><img src="<?php echo get_template_directory_uri();?>/images/icons/compare.png" alt=""><?php esc_html_e('Add to Compare', SH_NAME);?></a></li>
					<li><a data-toggle="modal" data-target="#myModal"><img src="<?php echo get_template_directory_uri();?>/images/icons/email.png" alt=""><?php esc_html_e('Email to a Friend', SH_NAME);?></a></li>
				</ul>
			</div>
			<div class="row m0 qtyAtc">
				<div class="fleft quantity_main">
					<div class="fleft"><?php esc_html_e('Qty ', SH_NAME);?><span>=</span></div>
				</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php esc_html_e('Email to a friend', SH_NAME);?></h4>
      </div>
      <form action="#" method="post" id="_mail_to_friend">
	  <div class="modal-body">
	  	
		
			<label for="email"><?php esc_html_e('Email Address', SH_NAME);?></label>
			...
			<label for="email"><?php esc_html_e('Email Content', SH_NAME);?></label>
...
Checkout this awesome product <?php the_permalink(); ?>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary"><?php esc_html_e('Send Email', SH_NAME);?></button>
      </div>
	  </form>
    </div>
  </div>
