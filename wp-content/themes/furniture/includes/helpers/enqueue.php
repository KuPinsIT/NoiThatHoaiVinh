...
class SH_Enqueue
{
	...
	function sh_enqueue_scripts()
	{
		...
		$styles = array( 
						 'Montserrat' => $protocol.'://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800|Montserrat:400,700',
 						 
						 'bootstrap' => 'css/bootstrap.min.css',
						 'bootstrap-theme' => 'css/bootstrap-theme.min.css',
						 'font-awesome' => 'css/font-awesome.min.css',
						 
						 'owl-carousel' => 'vendors/owl.carousel/css/owl.carousel.css', 
						 'light-box' => 'vendors/lightbox/css/lightbox.css', 
						 'flex-slider' => 'vendors/flexslider/flexslider.css', 
						 ...
						 'color_scheme' => 'css/color.php?color='.$color ,
					   );
		...
		$scripts = array( 
						  ...
						  'nicescroll'		=> 'vendors/nicescroll/jquery.nicescroll.js',
						  'lightbox'		=> 'vendors/lightbox/js/lightbox.min.js',		  
						  'tweet_script'	=> 'vendors/tweet/scripts.js',
						  'way-point' => 'vendors/waypoints/waypoints.min.js',
						  'counter-up' => 'vendors/counterup/jquery.counterup.min.js',
						  'owl-carousel' => 'vendors/owl.carousel/js/owl.carousel.min.js',
						  'jquery-isotop' => 'vendors/isotope/isotope-custom.js',
						  'flex-slider' => 'vendors/flexslider/jquery.flexslider-min.js',
						  'flicker-script'	 => 'js/jflickrfeed.min.js',
						  'custom-script'	 => 'js/furniture.js',
						 );
		...
		wp_enqueue_script( array('jquery', 'bootstrap', 'nicescroll', 'lightbox', 'tweet_script', 'way-point', 'counter-up', 'owl-carousel', 'jquery-isotop', 'flex-slider', 'custom-script'));
